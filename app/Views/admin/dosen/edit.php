            ...
            <div class="card-body">
                ...
                <form action="/user" method="post" class="forms-sample">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('fullname')) ? 'is-invalid' : '' ?>" name="fullname" id="fullname">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control <?= ($validation->hasError('no_ponsel')) ? 'is-invalid' : '' ?> mb-4 mb-md-0" data-inputmask-alias="(+62) 899-9999-99999" name="no_ponsel" id="no_ponsel" />
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control <?= ($validation->hasError('email')) ? 'is-invalid' : '' ?> mb-4 mb-md-0" data-inputmask="'alias': 'email'" name="email" id="email" />
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control <?= ($validation->hasError('user_image')) ? 'is-invalid' : '' ?> mb-4 mb-md-0" name="user_image" id="user_image" />
    ...
    <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form action="/admin/dosen" method="post" class="forms-sample">
                    <?= csrf_field() ?>
                    <input type="hidden" name="_method" value="put">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('nama_gelar')) ? 'is-invalid' : '' ?>" name="nama_gelar" id="nama_gelar">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('nip')) ? 'is-invalid' : '' ?>" name="nip" id="nip">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('nidn')) ? 'is-invalid' : '' ?>" name="nidn" id="nidn">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('kode')) ? 'is-invalid' : '' ?>" name="kode" id="kode">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('telepon')) ? 'is-invalid' : '' ?>" name="telepon" id="telepon">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('foto')) ? 'is-invalid' : '' ?>" name="foto" id="foto">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="maxlength-textarea" class="form-control <?= ($validation->hasError('alamat')) ? 'is-invalid' : '' ?>" maxlength="150" rows="8" name="alamat"></textarea>
